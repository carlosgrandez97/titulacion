                  ...
                  <div class="col-md-7 col-lg-8">
                    ...
                    <form class="needs-validation" name="frmEmpleadoAdm" id="frmEmpleadoAdm" novalidate="">
                      <div class="row g-3">
                        ...
                        <div class="col-md-5">
                          <label for="country" class="form-label">Personeria</label>
                        ...
                        <div class="col-sm-7">
                          <label for="lastName" class="form-label">DOI</label>
                        ...
                        <div class="col-md-6">
                          ...
                          <select class="form-select" id="optionCargo" required="">
                            <option value="">Elige...</option>
                      ...
                      <hr class="my-3">                      
                      <button class="w-100 btn btn-primary btn-lg" id="btnGurdarEmpleado" name="btnGurdarEmpleado"  type="submit">Continuar con el pago</button>
                    </form>
                  </div>
                </div>
              </main>
